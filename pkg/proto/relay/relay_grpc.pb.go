...
func (c *onlineMessageRelayServiceClient) OnlinePushMsg(ctx context.Context, in *OnlinePushMsgReq, opts ...grpc.CallOption) (*OnlinePushMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/pb_relay.OnlineMessageRelayService/OnlinePushMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *onlineMessageRelayServiceClient) GetUsersOnlineStatus(ctx context.Context, in *UsersOnlineStatusReq, opts ...grpc.CallOption) (*UsersOnlineStatusResp, error) {
	out := new(UsersOnlineStatusResp)
	err := c.cc.Invoke(ctx, "/pb_relay.OnlineMessageRelayService/GetUsersOnlineStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOnlineMessageRelayServiceServer) GetUsersOnlineStatus(context.Context, *UsersOnlineStatusReq) (*UsersOnlineStatusResp, error) {
...
func _OnlineMessageRelayService_OnlinePushMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb_relay.OnlineMessageRelayService/OnlinePushMsg",
	}
...
func _OnlineMessageRelayService_GetUsersOnlineStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb_relay.OnlineMessageRelayService/GetUsersOnlineStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OnlineMessageRelayServiceServer).GetUsersOnlineStatus(ctx, req.(*UsersOnlineStatusReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OnlineMessageRelayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb_relay.OnlineMessageRelayService",
